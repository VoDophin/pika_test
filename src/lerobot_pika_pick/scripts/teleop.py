...
import lerobot_pika_pick  # noqa: F401  (registers uf::pika_teleop / uf::mock_robot)
...
from lerobot_pika_pick import parser
from lerobot_pika_pick.utils import is_headless, init_keyboard_listener
...
class TeleopConfig:
    ...
    def __post_init__(self):
        # Single-arm teleop test: do not open cameras during the Pika check.
        self.robot.cameras = {}
